...
const BentoCard = ({
    ...
    >
        ...
        <div
            className={cn(
                "pointer-events-none absolute ml-2 bottom-0 flex w-full translate-y-10 transform-gpu flex-row items-center p-4 opacity-0 transition-all duration-300 group-hover:translate-y-0 group-hover:opacity-100"
            )}
        >
